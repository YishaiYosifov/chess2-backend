...
STARTING_POSITION: list[game_schema.Piece] = [
    ...
    game_schema.Piece(piece_type=enums.PieceType.HORSE, color=enums.Color.WHITE, x=1, y=0),
    ...
    game_schema.Piece(piece_type=enums.PieceType.HORSE, color=enums.Color.WHITE, x=8, y=0),
    ...
    game_schema.Piece(piece_type=enums.PieceType.HORSE, color=enums.Color.BLACK, x=8, y=9),
    ...
    game_schema.Piece(piece_type=enums.PieceType.HORSE, color=enums.Color.BLACK, x=1, y=9),
